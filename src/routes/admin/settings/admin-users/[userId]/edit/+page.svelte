...
<div class="user-edit-page">
  <div class="page-header">
    ...
    <div class="breadcrumb">
      ...
      <span>/</span>
      <a href="/admin/settings/admin-users">Admin Users</a>
      <span>/</span>
      <a href="/admin/settings/admin-users/{data.user.id}">{data.user.name}</a>
      <span>/</span>
      <span>Edit</span>
    </div>
  </div>
  ...
  <div class="form-container">
    ...
    >
      ...
      <div class="form-actions">
        <a href="/admin/settings/admin-users/{data.user.id}" class="button button-secondary">
          Cancel
        </a>
