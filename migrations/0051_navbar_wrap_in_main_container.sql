-- Migration: 0051_navbar_wrap_in_main_container
-- Description: Wrap Navigation Bar children in a main-container widget
-- This creates the structure:
--   config.children:
--     - main-container (type: container)
--         children:
--           - logo-container
--           - nav-links-container
-- Rollback: See migration 0049 for previous structure

-- Update the Navigation Bar component with a main-container wrapper
UPDATE components
SET 
  config = '{
    "containerPadding": {
